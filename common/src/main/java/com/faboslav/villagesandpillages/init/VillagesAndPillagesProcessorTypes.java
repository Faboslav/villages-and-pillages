...
public final class VillagesAndPillagesProcessorTypes
{
	...
	public static void postInit() {
		...
		StructureProcessorTypeRegistry.registerStructureProcessorType(VillagesAndPillages.makeID("village_witch_opened_door_processor"), VILLAGE_WITCH_OPENED_DOOR_PROCESSOR);
